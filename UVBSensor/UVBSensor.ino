...
/*
 Bearded Dragons and UV: https://www.beardeddragon.org/articles/uvintro/
 UVB emissions begin at 280 nanometers and go up to 320 nanometers.

 The wavelengths that are most important in Vitamin D3 synthesis are around 290 to 305nm. 
 The body simply will not manufacture vitamin D3 without the proper UVB exposure. 


 http://healthybuildingscience.com/2013/02/18/emf-and-emr-conversion-formulas/
